...
input_video = r"C:\Users\seren\OneDrive\Documents\Business\output_video_with_audio.mp4"
...
subprocess.run(['ffmpeg', '-i', output_video, '-i', output_audio, '-c:v', 'libx264', '-pix_fmt', 'yuv420p', '-c:a', 'aac', '-strict', 'experimental', 'output_video_with_audio2.mp4'])
